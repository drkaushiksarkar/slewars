...
class PostgresService {
  ...
  public async getDataElements(diseaseNames?: string[]): Promise<any[]> {
    let query = `
      SELECT
        de.dataelementid,
        de.uid,
  ...
  public async getOrganisationUnits(): Promise<any[]> {
    const query = `
      SELECT
  ...
  public async getDataValues(params: {
  ...
  public async getIndicators(diseaseNames?: string[]): Promise<any[]> {
    let query = `
      SELECT
        i.indicatorid,
        i.uid,
  ...
  public async getDiseaseStats(diseaseDataElementIds: number[], orgUnitId?: number): Promise<any> {
    let query = `
      SELECT
        de.name as disease,
    ...
    const params: any[] = [diseaseDataElementIds];
